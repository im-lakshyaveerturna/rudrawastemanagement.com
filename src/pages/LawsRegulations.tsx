    ...
    <div className="about-page">
      <section className="about-hero">
        <div className="container">
          <h1 className="page-title">Compliance and Standards</h1>
        </div>
      </section>
      <section className="about-team">
        <div className="container">
          ...
          <div className="commitment-content">
            <p>
              Under sections 6, 8, and 25 of the Environment (Protection) Act, 1986, the Central Government enacted the Biomedical Waste (Management & Handling) Rules to safeguard the public and healthcare workers from risks arising due to biomedical waste. Penalties align with those under the Environment (Protection) Act, 1986.
            </p>
            <p>
              Delhi hospitals alone produce more than 30 tonnes of biomedical waste every day, yet satisfactory management remains a challenge (CPCB, 2001). Centralized facilities help authorities monitor and maintain compliance more effectively.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="about-why-choose">
        <div className="container">
          ...
          <ul className="reasons-list">
            ...
            <li><strong>Authorization:</strong> Permission granted by the prescribed authority for generation, collection, reception, storage, transportation, treatment, disposal and/or handling of biomedical waste.</li>
            <li><strong>Authorized Person:</strong> Occupier/operator authorized to handle biomedical waste per these rules and Central Government guidelines.</li>
            <li><strong>Biomedical Waste:</strong> Waste generated during diagnosis, treatment or immunization of human beings or animals, or in research activities, including categories in Schedule I.</li>
          </ul>
        </div>
      </section>
      <section className="about-why-choose">
      ...
      <section className="about-why-choose">
        <div className="container">
          ...
          <ul className="reasons-list">
            ...
            <li>Label containers per Schedule III; if transported off‑premises, include Schedule IV information.</li>
            <li>Transport untreated biomedical waste only in authorized vehicles per competent authority.</li>
          </ul>
        </div>
      </section>
      <section className="about-why-choose">
